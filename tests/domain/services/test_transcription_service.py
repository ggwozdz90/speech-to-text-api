...
def mock_config() -> AppConfig:
    ...
    config.speech_to_text_model_name = "test_model"
    return config


@pytest.fixture
def mock_speech_to_text_repository() -> SpeechToTextRepository:
    return Mock(SpeechToTextRepository)
...
def transcription_service(
    ...
    mock_speech_to_text_repository: SpeechToTextRepository,
    ...
    return TranscriptionService(
        logger=mock_logger,
        config=mock_config,
        speech_to_text_repository=mock_speech_to_text_repository,
...
async def test_transcribe_success(
    ...
    mock_speech_to_text_repository.transcribe.return_value = {"text": "transcribed text", "segments": []}
